...
// Gallery feature (existing)
import '../features/gallery/data/services/photo_service.dart';
  ...
  static Widget wrap({required Widget child}) {
    ...
    return MultiProvider(
      providers: [
        ...
        // -----------------------------------------------------------------------
        // Gallery Feature Providers (existing)
        // -----------------------------------------------------------------------
        ChangeNotifierProvider<GalleryProvider>(
          create: (_) => GalleryProvider(
            repository: PhotoRepository(
              service: PhotoService(apiClient: apiClient),
            ),
          ),
        ),
      ],
